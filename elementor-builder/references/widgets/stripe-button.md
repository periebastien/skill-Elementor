# `stripe-button` — Bouton Stripe (Pro)
...
## onglet content
- section_stripe_account : `product_name`:txt, `donation_type`(any|fixed)[=fixed], `donation_amount`:nb[=1], `shipping_price`:nb[=0], `tax_rate`:nb[=0], `stripe_currency`(AED|AFN|ALL|AMD|ANG|AOA|ARS|AUD|AWG|AZN|…)[=USD], `stripe_product_price`:nb[=0.00], `stripe_quantity`:nb[=1], `shipping_amount`:nb[=0], `stripe_test_env_tax_rates_list`(), `stripe_live_env_tax_rates_list`()
...
- section_settings : `redirect_after_success`:url{url,is_external}, `sandbox_mode`:'yes'[=no], `open_in_new_window`:'yes'[=yes], `custom_messages`:'yes', `error_message_global`:txt, `error_message_payment`:txt
